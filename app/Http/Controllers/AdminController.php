...
class AdminController extends Controller
{
    ...
    public function addTourForm(): Renderable
    {
    ...
    public function editTourForm(Tour $tour): Renderable
    {
    ...
    public function deleteTourForm(Tour $tour): Renderable
    {
        return view('tour_delete', ['tour' => $tour]);
    }

    public function destroyTour(Request $request, Tour $tour): RedirectResponse
    {
        $tour->delete();
    ...
    public function chStatusForm(Order $order): Renderable
    {

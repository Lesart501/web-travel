                            ...
                            <div class="row">
                                <div class="col-md">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="place" id="txtTitle" class="form-control @error('place') is-invalid @enderror" value="{{$tour->place}}">
                                        @error('place')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="" cols="30" rows="10" class="form-control @error('description') is-invalid @enderror">{{$tour->description}}</textarea>
                                        @error('description')
                                            <span class="invalid-feedback">
                                                <strong>{{ $message }}</strong>
                                            </span>
